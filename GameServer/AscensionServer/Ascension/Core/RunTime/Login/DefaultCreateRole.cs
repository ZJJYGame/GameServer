        ...
        public OperationData CreateRole(Dictionary<byte, object> dataMessage)
        {
            ...
            if (role == null)
            {
                ...
                if (ringArray.RingIdArray == 0)
                {
                    ...
                    #region 测试初始化背包
                    ringDict.Add(11001, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11002, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11006, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11007, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11011, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11022, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11027, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11032, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11201, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11202, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11431, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11441, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11471, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11603, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(11604, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(12001, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(12401, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 90, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 99 });
                    ringDict.Add(13041, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13042, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13043, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13044, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13045, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13301, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13302, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13303, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13304, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13305, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13306, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13307, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13308, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13309, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13310, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13706, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13707, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13720, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(13721, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ...
                    ringDict.Add(15216, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(15271, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(15601, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(15602, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(15603, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(15604, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(15605, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount = 1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    ringDict.Add(15606, new RingItemsDTO() { RingItemAdorn = "0", RingItemCount =1, RingItemTime = DateTime.Now.ToString("yyyyMMddHHmmss"), RingItemMax = 1 });
                    #endregion
                    for (int i = 0; i < 6; i++)
